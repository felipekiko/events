...
<span class="tag">Mentoria ao Vivo - Fabricio Veronez</span>

&nbsp;

# AI for FinOps na prática
## Ferramentas AWS para unir a Inteligência artificial com FinOps!
...
- Exemplos:
```aws.amazon.com/blogs/aws-cloud-financial-management/preview-anomaly-detection-and-alerting-now-available-in-aws-cost-management/```
&nbsp;
```aws.amazon.com/blogs/aws-cloud-financial-management/announcing-general-availability-of-aws-cost-anomaly-detection/```
...
- **Serviço:**
```aws.amazon.com/aws-cost-management/cost-optimization-hub/```

&nbsp;

- Exemplo:
```aws.amazon.com/blogs/aws/new-cost-optimization-hub-to-find-all-recommended-actions-in-one-place-for-saving-you-money/```
---
...
**IMPORTANTE:** Antes, Q Developer que agora virou **Kiro**!
&nbsp;

### O que é...no contexto de billing!

- Interface de linguagem natural integrada ao **AWS Cost Management**
- Acessa dados do **CUR, Savings Plans, Reserved Instances**...
...
- Exemplos:
```aws.amazon.com/blogs/aws-cloud-financial-management/introducing-ai-powered-cost-analysis-in-aws-cost-explorer/```
&nbsp;
```aws.amazon.com/blogs/devops/analyzing-your-aws-cost-explorer-data-with-amazon-q-developer-now-generally-available/```
...
&nbsp;
&nbsp;
- Amazon Q será descontinuado, entra o poderoso **Kiro**!
```aws.amazon.com/blogs/devops/amazon-q-developer-end-of-support-announcement/```
&nbsp;
- Camada de agentes de IAcom o AWS FinOps Agent (preview)
```aws.amazon.com/finops-agent/```
